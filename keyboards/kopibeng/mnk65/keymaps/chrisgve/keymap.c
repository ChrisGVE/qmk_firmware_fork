...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_MAC_NAV_1] = LAYOUT_chrisgve(
		...
		_______, _______, M_F_WRD, _______, _______, _______, _______, _______, _______, _______, M_PUT,   _______, _______, _______,          _______,
	...
	[_LINUX_NAV_1] = LAYOUT_chrisgve(
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, L_F_WRD, _______, _______, _______, _______, _______, _______, _______, L_PUT,   _______, _______, _______,          _______,
	...
	[_WIN_NAV_1] = LAYOUT_chrisgve(
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, W_F_WRD, _______, _______, _______, _______, _______, _______, _______, W_PUT,   _______, _______, _______,          _______,
	...
	[_ADJUST] = LAYOUT_chrisgve(
		...
		_______,          DF_MAC,  DF_LNX,  DF_WIN,  DF_GMG,  _______, _______, KC_MUTE, _______, _______, _______, _______,          KC_VOLU, _______,
	...
	[_EX_MOUSE] = LAYOUT_chrisgve(
		...
		XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_U, KC_WH_D, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_MS_U, XXXXXXX,
