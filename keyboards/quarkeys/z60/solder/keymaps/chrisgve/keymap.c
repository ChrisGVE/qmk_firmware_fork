...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY_WIN] = LAYOUT_60_tsangan_hhkb(
		...
		SFT_MSE, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          R_SHIFT, ADJUST, 
		XXXXXXX, KC_LGUI, KC_LALT,                            SPC_RSE,                                              KC_RALT, KC_RGUI, _______
    ),
	...
	[_WIN_NAV_1] = LAYOUT_60_tsangan_hhkb(
		...
		_______, _______, W_DEL,   _______, W_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______,          _______, _______, 
		_______, _______, _______,                            _______,                                              _______, _______, _______
    ),
	...
	[_ADJUST] = LAYOUT_60_tsangan_hhkb(
		...
		QK_BOOT, MAC_SWT, _______, WIN_SWT, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,
		KC_CAPS, DF_M_P,  DF_L_P,  DF_W_P,  _______, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, _______,          _______, 
		_______, DF_MAC,  DF_LNX,  DF_WIN,  DF_GMG,  _______, _______, KC_MUTE, _______, _______, _______,          _______, _______, 
